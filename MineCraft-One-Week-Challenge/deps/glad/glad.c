/*
    ...
    OpenGL loader generated by glad 0.1.36 on Wed Feb  7 22:57:59 2024.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c" --spec="gl" --local-files --extensions="GL_ARB_debug_output,GL_KHR_debug"
    Online:
